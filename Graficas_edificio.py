...
omegas=np.genfromtxt("data_posiciones.dat",usecols=(0))
U1_max=np.genfromtxt("data_posiciones.dat",usecols=(1))
U2_max=np.genfromtxt("data_posiciones.dat",usecols=(2))
U3_max=np.genfromtxt("data_posiciones.dat",usecols=(3))


plt.figure()
plt.plot(omegas,U1_max, c="cyan", label="primer piso", linewidth=0.7)
